 ...
 *      - ESP_UI_LOG_STYLE_STD:  Use printf to output log
 *      - ESP_UI_LOG_STYLE_ESP:  Use ESP_LOGx to output log
 *      - ESP_UI_LOG_STYLE_LVGL: Use LV_LOG_x to output log
 *
 */
...
#else
#define ESP_UI_MEMORY_INCLUDE       "esp_heap_caps.h"
#define ESP_UI_MEMORY_MALLOC(x)     heap_caps_aligned_alloc(1, x, MALLOC_CAP_SPIRAM)
#define ESP_UI_MEMORY_FREE          free
#endif
...
// #define ESP_UI_SQ1_4_0_LV8_3_6       // |   1.4.0    | 8.3.6  |
// #define ESP_UI_SQ1_4_0_LV8_3_11      // |   1.4.0    | 8.3.11 |
// #define ESP_UI_SQ1_4_1_LV8_3_6       // |   1.4.1    | 8.3.6  |
#define ESP_UI_SQ1_4_1_LV8_3_11      // |   1.4.1    | 8.3.11 |
 ...
 * the current version of `esp_ui_conf.h` in the library. The detailed rules are as follows:
 *
